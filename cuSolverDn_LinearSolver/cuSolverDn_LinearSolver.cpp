...
int main (int argc, char *argv[])
{
    ...
    cbstat = cublasSgemm(cublasHandle,CUBLAS_OP_T,CUBLAS_OP_N,colsA,colsA,rowsA,&al,d_A,colsA,dAcopy,rowsA,&bet,dAtA,colsA);
    checkCudaErrors(cudaDeviceSynchronize());
    ...
    if ( 0 == strcmp(opts.testFunc, "chol") )
    {
        linearSolverCHOL(handle, rowsA, dAtA, lda, d_Atb, d_x);
    }
    else if ( 0 == strcmp(opts.testFunc, "lu") )
    {
        linearSolverLU(handle, rowsA, dAtA, lda, d_Atb, d_x);
    }
    else if ( 0 == strcmp(opts.testFunc, "qr") )
    {
        linearSolverQR(handle, rowsA, dAtA, lda, d_Atb, d_x);
    }
    else
    {
